...
const Teaching = () => {
  return (
    <div>
      ...
      <h1>English Teaching experience</h1>
      <div className="text">
      ...
      <li>
        ...
        <ul>
          ...
          connected the village with the NGO EcoHimal and several other projects
          followed [link to NGO work page]. While teaching there, we
      ...
      <div>
        ...
        <p className="text">
          Caballo Blanco. Lanjarón, Spain: Excursions, horse training, giving
          riding lessons. [https://caballoblancotrekking.com/]
        </p>
        <p className="text">
          Pottoka’s Project. Extremadura, Spain: Assistant to ethologist Lucy
          Rees with study and management of feral Pottokas.
          [https://wildhorsesinspain.wordpress.com/pottokas-project/]
        </p>
        <p className="text">
        ...
        <p className="text">
          Frontier Lab. Urubamba, Peru: Excursions and assistant in equine
          therapy sessions, giving riding lessons. [http://www.frontierlab.org/]
        </p>
        <p className="text">
          Atacama Horse Adventures. San Pedro de Atacama, Chile: Multiple day
          excursions. [https://atacamahorse.com/]
        </p>
        <p className="text">
          Haggis Farm Polo Club. Cambridge. UK: Polo Groom.
          [https://www.facebook.com/cambridgepolohaggisfarm/]
        </p>
      </div>
    </div>
  );
